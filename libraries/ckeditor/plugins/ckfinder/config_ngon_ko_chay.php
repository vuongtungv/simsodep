...
//	if( (!isset($_SESSION["ad_logged"]) || ($_SESSION["ad_logged"] != 1)) && (!isset($_SESSION["cms_logged"]) || ($_SESSION["cms_logged"] != 1)){
//		return false;
//	}
...
create_folder($baseUrl . '_thumbs/Images/'.$year.'/'.$month.'/'.$day.'/');
create_folder($baseUrl . 'images/'.$year.'/'.$month.'/'.$day.'/');

$config['Thumbnails'] = Array(
		'url' => $baseUrl . '_thumbs/'.$year.'/'.$month.'/'.$day.'/',
		'directory' => $baseDir .  '_thumbs/'.$year.'/'.$month.'/'.$day.'/',
		'enabled' => true,
		'directAccess' => false,
		'maxWidth' => 100,
		'maxHeight' => 100,
...
$config['ResourceType'][] = Array(
		'name' => 'Images',
		'url' => $baseUrl . 'images/'.$year.'/'.$month.'/'.$day.'/',
		'directory' => $baseDir . 'images/'.$year.'/'.$month.'/'.$day.'/',
		'maxSize' => 0,
