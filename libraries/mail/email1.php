...
class Email1 extends PHPMailer
{	
	/**
	...
	function &Send()
	{
        ...
        switch($random){
            case 1:
                ...
                $email = 'info@ketnoigiaoduc.vn';
                $pass = 'lzsaw{JZnHDE';
                break;
            case 2:
                $server = 'pro17.emailserver.vn';
                $email = 'info1@ketnoigiaoduc.vn';
                $pass = 'WCGiL7u8puS{';
                break;
            case 3:
                $server = 'pro17.emailserver.vn';
                $email = 'info2@ketnoigiaoduc.vn';
                $pass = ']J^&3Q1cvl^S';
                break;
            case 4:
                $server = 'pro17.emailserver.vn';
                $email = 'info3@ketnoigiaoduc.vn';
                $pass = '&m]4u-Vv~#h;';
                break;
            case 5:
                $server = 'pro17.emailserver.vn';
                $email = 'info4@ketnoigiaoduc.vn';
                $pass = 'i00?[+kM40}4';
                break;
            case 6:
                $server = 'pro17.emailserver.vn';
                $email = 'info5@ketnoigiaoduc.vn';
                $pass = ']D^TrXwVmq^$';
                break;
            case 7:
                $server = 'pro17.emailserver.vn';
                $email = 'info6@ketnoigiaoduc.vn';
                $pass = '=P(E[$qza}TK';
                break;
            case 8:
                $server = 'pro17.emailserver.vn';
                $email = 'info7@ketnoigiaoduc.vn';
                $pass = 'Rz0[[-FRSy8o';
                break;
            case 9:
                $server = 'pro17.emailserver.vn';
                $email = 'info8@ketnoigiaoduc.vn';
                $pass = 'iE,SMN%60[X2';
                break;
            case 10:
                $server = 'ssl://pro17.emailserver.vn';
                $email = 'info9@ketnoigiaoduc.vn';
                $pass = 'm[0gfl9iT?oF';
                break;    
        }
        
		$this -> useSMTP(true,$server,$email,$pass,'ssl',465);	
        //$this -> useSMTP(true,'ssl://mail.thts.vn','info@sstravelviet.com','sstravel123456','ssl',465);				
