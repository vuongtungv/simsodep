...
class NL_Checkout 
{
	...
	// Mã merchante site 
	private $merchant_site_code = '22707';	// Biến này được nganluong.vn cung cấp khi bạn đăng ký merchant site
	...
	// HUYPV write:
	// set 2 param:
//	function set_nl_check_out($merchant_site_code,$secure_pass){
