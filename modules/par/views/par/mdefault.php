...
?>
    ...
    <div class="view-all-sims">
        ...
        <div class="bg-head">
            ...
            <div class="show-pagination">
                ...
                <div class="show-value">
                    <span>Sắp sếp: </span>
                    <select name="" id="" class="select_location">
        ...
        <table class="table-list">
            ...
            <tr>
                <td width="10%" class="stt"><?php echo $i ?></td>
                <td width="40%" class="body-i">
                        ...
                        <div class="modal-content">
                            <div class="show-pop-sim">
                                <div class="table-list">
                                    <div class="td" style="width:10%" class="stt"><a class="sim-num"><?php echo $i ?></a></div>
                            ...
                            <div class="pop_mobile_add_cart">
                                <div class="detail-cart-show">
                                    ...
                                    <div style="display:<?php echo $exit_cart == 'no_cart'?'none':'block'; ?>" class="redrect-cart delete-sim<?php echo $item['sim_id'] ?>">
                                        <span class="title-pop" cart="exit_cart" type="list" onclick="action_cart('<?php echo $item['number'] ?>','<?php echo $item['sim_id'] ?>','<?php echo $item['price_public'] ?>','<?php echo $item['network'] ?>','<?php echo $cat_name ?>','<?php echo $item['point'] ?>','<?php echo $item['button'] ?>',this)">Xóa sim khỏi giỏ hàng</span>
                                        <span class="title-pop">
