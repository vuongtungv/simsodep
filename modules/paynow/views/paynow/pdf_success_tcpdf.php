...
include(PATH_BASE.'libraries/TCPDF/examples/tcpdf_include.php');

// create new PDF document
require_once(PATH_BASE.'libraries/TCPDF/tcpdf.php');
...
<h3 style="width: 500px; height: 200px; border-radius: 50px;">REMOVE CELL PADDING</h3>
...
$pdf->Output(URL_ROOT.'images/example_061.pdf', 'D');
