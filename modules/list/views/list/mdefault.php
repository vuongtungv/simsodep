                        ...
                        <div class="modal-content">
                            <div class="show-pop-sim">
                                <div class="table-list">
                                    <div class="td" style="width:10%" class="stt"><a class="sim-num stt_sim"><?php echo $i ?></a></div>
...
<!--             <div class="box-sort-price">
            ...
            <?php echo $tmpl->load_direct_blocks('filter', array('style' => 'mfilter','url' => $url, 'type' => 'list')); ?>
