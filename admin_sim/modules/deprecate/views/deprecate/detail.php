...
//    $toolbar->setTitle($title);
	...
	$this -> dt_form_begin(1,4,FSText::_('Chi tiết tìm sim'));
...
?>
<input type="hidden" name="deprecate_id" id="deprecate_id" value="<?php echo FSInput::get('id')?>">
...
<!--    <div class="form-group">-->
<!--        <label class="col-md-2 col-xs-12 control-label">--><?php //echo FSText::_('Nhân viên')?><!--</label>-->
<!--        <div class="col-md-10 col-xs-12">-->
<!--            <select name="user_cd" id="user_cd" class="form-control">-->
<!--                --><?php //foreach ($list_user as $key => $item){?>
<!--                    <option value="--><?php //echo $item->id?><!--" --><?php //if(@$data->user_id == $item->id) echo "selected"?><!--><?php //echo $item->full_name?><!--</option>-->
<!--                --><?php //}?>
<!--            </select>-->
<!--        </div>-->
<!--    </div>-->
...
<!--    </div>-->
    ...
    <div class="form-group">
        <label class="col-md-2 col-xs-12 control-label"><?php echo FSText::_('6 số sim cuối muốn tìm')?></label>
        <div class="col-md-10 col-xs-12">
            <textarea disabled="disabled" class="form-control" name="deprecate_six" id="deprecate_six"><?php echo @$data->six_last ?></textarea>
        </div>
    </div>
    <div class="form-group">
        <label class="col-md-2 col-xs-12 control-label"><?php echo FSText::_('Giá tiền mong muốn')?></label>
        <div class="col-md-10 col-xs-12">
            <textarea disabled="disabled" class="form-control" name="deprecate_price" id="deprecate_price"><?php echo format_money(@$data->price,'') ?></textarea>
        </div>
    </div>
<?php
...
<script  type="text/javascript" language="javascript">
    ...
    $('.save_comments').click(function () {
        ...
        $.ajax({url: "<?php echo URL_ROOT.URL_ROOT_ADMIN ?>index.php?module=deprecate&task=save_comments&raw=1",
    ...
    $('#add_note').click(function () {
        ...
        $.ajax({url: "<?php echo URL_ROOT.URL_ROOT_ADMIN ?>index.php?module=deprecate&task=save_note&raw=1",
            data: {id: $deprecate_id, note: $note},
            dataType: "html",
            success: function (result) {
                if (result) {
