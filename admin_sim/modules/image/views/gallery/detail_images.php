...
<script type="text/javascript">
		$(function() {
			...
			$('#file_upload').uploadify({
				...
				'uploader' : 'index2.php?module=gallery&view=gallery&raw=1&ad_lang=<?php echo $_SESSION['ad_lang'] ?>&task=upload_other_images&data=<?php echo $uploadConfig;?>',
				'onUploadComplete' : function(){
                    $("#feeds").load("index2.php?module=gallery&view=gallery&raw=1&task=get_other_images&data=<?php echo $uploadConfig;?>");
                } 
			});
	});
</script>
