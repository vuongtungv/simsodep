<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Nhà Đào tạo đăng ký') );
...
//	$toolbar->addButton('unpublished',FSText :: _('Unpublished'),FSText :: _('You must select at least one record'),'unpublished.png');
	...
	$list_config[] = array('title'=>'Chương trình KM','field'=>'promotion_id','ordering'=> 1, 'type'=>'edit_selectbox','col_width' => '25%','arr_params'=>array('arry_select'=>$promotion,'field_value'=>'id','field_label'=>'title','size'=>1));
