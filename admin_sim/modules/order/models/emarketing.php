<?php
    class OrderModelsEmarketing extends FSModels
    {
        public $limit;
        public $prefix ;
        public function __construct()
        {
            $this -> limit = 40;
            $this -> view = 'service';
            $this -> table_name = 'fs_order_4';
            $this -> table_name_item = 'fs_order_4_item';
            parent::__construct();
        }
    ...
    //        $row['date_end'] = $end;
            ...
            if ($id && $row['status'] == 1) {
                ...
                $setSubject = $global_class->getConfig_email('subject_comfim_service_post');
                    $setSubject = str_replace('{code}', 'E-marketing  -'.$order->code, $setSubject);
                ...
                $body = str_replace('{date_start}', date('d-m-Y', strtotime($row['date_start'])), $body);
                    ...
                    $title = FSText::_('E-marketing 30 ngày');
