                        ...
                        <table class="table table-bordered table-hover"> 
                            ...
                            <tbody> 
                                ...
                                <tr> 
                                    ...
                                    <td><?php echo format_money($item->total_,'','0') ?></td> 
                                    <td><?php echo format_money($item->total_vat,'','0') ?></td> 
                                    <td><?php echo format_money($item->total_rs,'','0') ?></td> 
                                    <td><?php echo $array_status_item[$item->status] ?></td>
