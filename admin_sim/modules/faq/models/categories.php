<?php 
	class FaqModelsCategories extends ModelsCategories
	{
		function __construct()
		{
			$this -> limit = 20;
			
			$this -> table_items = FSTable_ad::_('fs_faq');
			$this -> table_name = FSTable_ad::_('fs_faq_categories');
			$this -> check_alias = 1;
			...
			$cmonth = date('m');
			$cday = date('d');
			$this -> img_folder = 'images/faq/cat/'.$cyear.'/'.$cmonth;
