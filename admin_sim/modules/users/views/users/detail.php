...
$this->dt_form_begin(1, 4, $title . ' ' . FSText::_('Đại lý'));
...
TemplateHelper::dt_edit_text(FSText :: _('Tên đại lý'), 'full_name', @$data->full_name, '', 500);
...
TemplateHelper::dt_checkbox(FSText::_('Ưu tiên'), 'is_hot', @$data->is_hot, 0);
...
TemplateHelper::dt_edit_selectbox(FSText::_('Chiết khấu / Tăng giảm giá sim'),'price',@$data ->price ? @$data ->price:'1','1',$price,$field_value = 'id', $field_label='name','',0,1,'');
?>
<?php 
...
<script type="text/javascript">
    ...
    function formValidator()
    {
        ...
        if (!notEmpty('full_name', 'Nhập tên đại lý'))
            return false;
