<?php  
global $toolbar;
$toolbar->setTitle(FSText :: _('Trình độ') );
...
//CONFIG	
$list_config = array();
$list_config[] = array('title'=>'Tên nhóm câu hỏi','field'=>'name','ordering'=> 1, 'type'=>'text','col_width' => '25%', 'align'=>'left', 'arr_params'=>array('size'=> 30));
