...
<!-- HEAD -->
    ...
    ///$this -> dt_form_begin(1,6,FSText::_('Ảnh'),'fa-image',1,'col-md-4 fl-right');
...
//    $this->dt_form_end_col(); // END: col-4
    ...
    //$this -> dt_form_begin(1,4,FSText::_('Thông tin'),'fa-info',1,'col-md-12');
//        TemplateHelper::dt_edit_text(FSText :: _('Thông tin thêm'),'content',@$data -> content,'',650,450,1,'','','col-sm-12','col-sm-12');
//    $this->dt_form_end_col(); // END: col-4
