<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Danh sách nhóm khóa học') );
	...
	//	CONFIG	
	$list_config = array();
	$list_config[] = array('title'=>'Tên nhóm khóa học','field'=>'name','ordering'=> 1, 'type'=>'text','col_width' => '30%','align'=>'left','arr_params'=>array('have_link_edit'=> 1));
	...
	$list_config[] = array('title'=>'Created time','field'=>'date_created','ordering'=> 1, 'type'=>'date');
