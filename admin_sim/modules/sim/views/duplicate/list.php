...
<?php  
	...
	$list_config[] = array('title'=>'Đại lý','field'=>'author','ordering'=> 1, 'type'=>'text');
	$list_config[] = array('title'=>'Giá bán','field'=>'price','ordering'=> 1, 'type'=>'format_money');
	$list_config[] = array('title'=>'Chiết khấu','field'=>'author','ordering'=> 1, 'type'=>'text');
	$list_config[] = array('title'=>'Giá sau chiết khấu','field'=>'author','ordering'=> 1, 'type'=>'text');
	$list_config[] = array('title'=>'Trạng thái','field'=>'status','ordering'=> 1, 'type'=>'status');
