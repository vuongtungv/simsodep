<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Banners') );
	...
	//	CONFIG	
	$list_config = array();
	$list_config[] = array('title'=>'Tên banner','field'=>'name','ordering'=> 1, 'type'=>'edit_text','col_width' => '30%','arr_params'=>array('size'=> 40));
	$list_config[] = array('title'=>'Danh mục banner','field'=>'category_name','ordering'=> 1, 'type'=>'text','col_width' => '30%');
	$list_config[] = array('title'=>'Image','field'=>'image','type'=>'image','arr_params'=>array('width'=>'60','height'=>''));
