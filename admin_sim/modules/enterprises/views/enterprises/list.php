<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Doanh nghiệp') );
	...
	//	CONFIG	
	$list_config = array();
	$list_config[] = array('title'=>'Tên doanh nghiệp','field'=>'title','ordering'=> 1, 'type'=>'text','col_width' => '20%','arr_params'=>array('size'=> 30));
	//$list_config[] = array('title'=>'Title','field'=>'','type'=>'text','align'=>'left','col_width' => '20%');
	$list_config[] = array('title'=>'Logo','field'=>'image','type'=>'image','no_col'=>0,'arr_params'=>array('search'=>'/original/','replace'=>'/resized/'));
	//$list_config[] = array('title'=>'Summary','field'=>'summary','type'=>'edit_text','col_width' => '20%','arr_params'=>array('size'=>30,'rows'=>8));
	$list_config[] = array('title'=>'Danh mục','field'=>'category_id','ordering'=> 1, 'type'=>'edit_selectbox','arr_params'=>array('arry_select'=>$categories,'field_value'=>'id','field_label'=>'treename','size'=>10));
	//$list_config[] = array('title'=>'Tin nổi bật','field'=>'is_hot','ordering'=> 1, 'type'=>'change_status','arr_params'=>array('function'=>'is_buy_showinfor'));
