<div class="products_related">
			...
			<td width="100%" id='products_related_r'>
				...
				<div class='title'>Tin liên quan</div>
					<ul id='products_sortable_related'>	
						...
						?>
							<li id='products_record_related_<?php echo $item ->id?>'><?php echo $item -> title; ?> 
	...
	<div class='products_add_related'>
		<a href="javascript:products_add_related()"><strong class='red'>Thêm tin liên quan</strong></a>
	</div>
</div>
