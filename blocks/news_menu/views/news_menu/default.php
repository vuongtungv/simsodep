...
<div class="news_menu">
	<!--	CONTENT -->
        <div id='css_menu'>
            <ul class='nav-news-menus row-item' >
                <li class="has-sub item_home level_0  " id="pr_2">
                    <div class="a2_0">
            ...
            <div class="news_search">
                <span class="click-show" data-id="mmenu_search_news">&nbsp;</span>   
                <?php include_once 'default_search.php';?>       
            </div>
        </div>    
	<!--	end CONTENT --> 
</div> 